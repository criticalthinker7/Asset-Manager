...
import { getAssistantReply } from "@/lib/grant-assistant";
import { WishlistBanner } from "@/components/WishlistBanner";

const canGrantsLogo = `${import.meta.env.BASE_URL}cangrants-logo.svg`;
          ...
          <div style={{ display:"flex", flexDirection:"column", alignItems:"center", textAlign:"center", paddingTop:"8vh" }}>
            ...
            <div style={{ background:"rgba(200,168,75,0.06)", border:"1px solid rgba(200,168,75,0.2)", borderRadius:20, padding:"40px 50px", maxWidth:580, width:"100%", backdropFilter:"blur(10px)", marginBottom:50 }}>
              ...
              <p style={{ fontSize:14, color:"#8A9C8A", lineHeight:1.7, margin:"0 0 28px" }}>
                {GRANTS.length}+ funding opportunities \u00b7 AI-powered eligibility matching \u00b7 Proposal drafting assistant \u00b7 Deadline tracker
              </p>
            ...
            <div style={{ display:"grid", gridTemplateColumns:"repeat(auto-fit,minmax(200px,1fr))", gap:20, width:"100%", marginBottom:60 }}>
              {[
                { icon:"\ud83d\udd0d", title:"Grant Discovery", desc:`${GRANTS.length}+ curated grants from Telefilm, TAC, CMF, NFB, Sundance, Berlinale & more` },
      ...
      <div style={{ maxWidth:1200, margin:"0 auto", padding:"28px 20px" }}>
        ...
        {activeTab==="assistant" && (
          <div style={{ maxWidth:760, margin:"0 auto" }}>
            ...
            <p style={{ textAlign:"center", fontSize:12, color:"#aaa", marginTop:12 }}>CanGrants assistant \u00b7 Grant-aware recommendations &amp; drafts</p>
          </div>
        )}
      </div>
